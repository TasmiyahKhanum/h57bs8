class Game {
    ...
    start(){
      player = new Player();
        ...
        gon1 = createSprite(windowWidth/2,windowHeight/2);
       ...
       // gon1.y=mouseY;
        ...
        gon2 = createSprite(windowWidth/2,windowHeight/2);
        ...
        gon3 = createSprite(windowWidth/2,windowHeight/2);
    ...
    play(){
        ...
        for(var plr in allPlayers){
            ...
            var y = 500-allPlayers[plr].positionY;
